...
import 'package:legends_management/feature/admin/department/presentation/viewmodel/employeedepartmentcubit/employeebydepartment_cubit.dart';

import '../../../../../core/utils/app_styles.dart';
import '../../../../../core/utils/size_config.dart';
import 'widgets/department_employee_card.dart';

class DesignDepartmentContent extends StatelessWidget {
  const DesignDepartmentContent({super.key});
        ...
        Expanded(
          child: BlocProvider(
            create: (context) => EmployeebydepartmentCubit()
              ..getEmployeesByDepartments(department: 'Design'),
