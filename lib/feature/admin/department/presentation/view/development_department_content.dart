...
class DevelopmentDepartmentContent extends StatelessWidget {
  const DevelopmentDepartmentContent({super.key});
        ...
        Expanded(
          child: BlocProvider(
            create: (context) => EmployeebydepartmentCubit()
              ..getEmployeesByDepartments(department: 'Development'),
