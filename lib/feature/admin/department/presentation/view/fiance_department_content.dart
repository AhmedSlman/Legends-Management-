...
class FianceDepartmentContent extends StatelessWidget {
  const FianceDepartmentContent({super.key});
        ...
        Expanded(
          child: BlocProvider(
            create: (context) => EmployeebydepartmentCubit()
              ..getEmployeesByDepartments(department: 'Accounting and Finance'),
